...
- The C++ reference part ([docs/Cpp.md](https://github.com/JeffersonLab/rcdb/blob/main/docs/Cpp.md)) is hand-written Markdown
...
- Docsify uses GFM (Git Flavored Markdown) with additional features such as possibility to include one document in another
...
The cover page is currently disabled (`coverpage: false` in `docs/index.html`). 
...
- Theme switcher [github](https://github.com/boopathikumar018/docsify-darklight-theme)
